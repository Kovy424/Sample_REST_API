...
new_employee = {'Name': 'Michelle Sanders', 'Age': 32, 'Employee_ID': 1032}
...
# Adding an endpoint to add a new employee to the database
@app.route('/employees', methods=["POST"])
def add_employee():
    employee_addition = employees.append(new_employee)
    return jsonify({"Updated list of employees": employee_addition})
